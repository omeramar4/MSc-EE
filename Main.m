...
for i=1:N
    ...
    %probability p
    %-----------------------------------------------------
    [Queue,DelayTrack,HowManyTrack,CountPackets,totalSimilarDecisions,totalDecisions,empiricTotalCost,NumOfTimesPathChosen] = Step_0(flow,Queue,K,p,DelayTrack,i,HowManyTrack,W,CountPackets,pathsMeanCosts,totalSimilarDecisions,totalDecisions,distribution,Paths,links,empiricTotalCost,NumOfTimesPathChosen);
    %-----------------------------------------------------
